...
- A clean summary or submitted review counts only after the exact-run observer job saw the
  connector's eyes on that same request and the required Gate later observed the eyes clear.
